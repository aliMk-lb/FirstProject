      ...
      <section className='dark:bg-darkmode pt-8 md:pb-24 pb-16'>
        <div className='container mx-auto max-w-6xl px-4'>
            ...
            <div className='flex sm:flex-row flex-col items-start sm:gap-8 gap-4'>
              ...
              <div className='flex md:flex-col sm:flex-row flex-col md:items-start sm:items-center items-start h-full justify-between'>
                <div>
                  ...
                  <p className='text-DeepOcean font-normal text-lg max-w-80 pt-3 pb-7 dark:text-white/50'>
                    Build, learn, and grow with our team.
                  </p>
                </div>
                <div>
                  <Link
          ...
          <div className='md:pt-32 pt-11 md:pb-28 pb-8'>
            <iframe
              src='https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d6162.317333306715!2d35.497695927012195!3d33.88432884033348!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x151f1721587e1d6d%3A0xaa7f5769dc576d98!2sLebanese%20International%20University!5e0!3m2!1sen!2slb!4v1767120379079!5m2!1sen!2slb" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade'
              width='1114'
              height='477'
              loading='lazy'
